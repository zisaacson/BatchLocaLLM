...
class OllamaBackend:
    ...
    async def generate_chat_completion(
        ...
        if request.temperature is not None:
            ollama_request["options"]["temperature"] = request.temperature  # type: ignore[index]
        if request.max_tokens is not None:
            ollama_request["options"]["num_predict"] = request.max_tokens  # type: ignore[index]
        if request.top_p is not None:
            ollama_request["options"]["top_p"] = request.top_p  # type: ignore[index]
        if request.frequency_penalty is not None:
            ollama_request["options"]["frequency_penalty"] = request.frequency_penalty  # type: ignore[index]
        if request.presence_penalty is not None:
            ollama_request["options"]["presence_penalty"] = request.presence_penalty  # type: ignore[index]
        if request.stop:
            ollama_request["options"]["stop"] = request.stop  # type: ignore[index]
