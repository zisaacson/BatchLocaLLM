...
class BatchMetrics:
    ...
    def update_context(self, context_length: int, was_trimmed: bool = False) -> None:
    ...
    def update_vram(self, vram_gb: float) -> None:
        """Update VRAM metrics"""
        self.peak_vram_gb = max(self.peak_vram_gb, vram_gb)

    def estimate_cached_tokens(self, system_prompt_tokens: int) -> None:
        """
