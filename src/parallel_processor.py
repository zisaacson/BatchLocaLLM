...
class ParallelBatchProcessor:
    ...
    async def process_batch(
        ...
        tasks = [
            ...
            for worker, chunk in zip(workers, chunks, strict=False)
        ]
        ...
        # Aggregate results
        all_results: list[BatchResultLine] = []
        worker_errors = []
        ...
        success_count = sum(1 if r.error is None else 0 for r in all_results)
        fail_count = sum(1 if r.error is not None else 0 for r in all_results)
