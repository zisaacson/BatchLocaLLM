#!/usr/bin/env python3
"""
Test IBM Granite 3.1 3B with a single request to verify it loads and works.
"""
...
from models.granite_3b import GRANITE_3B
...
def main():
    print("=" * 80)
    print("🧪 IBM GRANITE 3.1 3B - SINGLE REQUEST TEST")
    print("=" * 80)
    print()
    
    print(f"Model: {GRANITE_3B.model_id}")
    print(f"Expected memory: {GRANITE_3B.estimated_memory_gb} GB")
    print(f"GPU memory utilization: {GRANITE_3B.gpu_memory_utilization}")
    print()
    ...
    try:
        ...
        llm = LLM(**GRANITE_3B.get_vllm_kwargs())
...
Provide your evaluation in JSON format."""
        ...
        print()
        print("Next steps:")
        print("1. Run 100 request test: python core/tests/manual/test_granite_3b_100.py")
        print("2. Run 5K batch test: bash scripts/test_granite_3b_5k_offline.sh")
