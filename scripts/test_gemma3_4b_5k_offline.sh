...
# vLLM Offline Batch Processing for Gemma 3-4B with 5K candidates
...
INPUT_FILE="batch_5k_gemma3_4b.jsonl"
OUTPUT_FILE="gemma3_4b_5k_offline_results.jsonl"
LOG_FILE="gemma3_4b_5k_offline.log"
