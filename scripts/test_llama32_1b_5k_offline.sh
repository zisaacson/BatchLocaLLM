...
# vLLM Offline Batch Processing for Llama 3.2-1B with 5K candidates
...
INPUT_FILE="batch_5k_llama32_1b.jsonl"
OUTPUT_FILE="llama32_1b_5k_offline_results.jsonl"
LOG_FILE="llama32_1b_5k_offline.log"
