...
# vLLM Offline Batch Processing for Llama 3.2-3B with 5K candidates
...
INPUT_FILE="batch_5k_llama32_3b.jsonl"
OUTPUT_FILE="llama32_3b_5k_offline_results.jsonl"
LOG_FILE="llama32_3b_5k_offline.log"
