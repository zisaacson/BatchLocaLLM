#!/usr/bin/env python3
"""
Test GPT-OSS 20B with FP8 quantization - Single Candidate
Strategy: Use FP8 quantization (native vLLM support) to fit 20B model on RTX 4080 16GB
"""
...
def main():
    print("=" * 80)
    print("GPT-OSS 20B - SINGLE CANDIDATE TEST (FP8 QUANTIZATION)")
    print("=" * 80)
    print("Strategy: Use FP8 quantization to fit 20B model on RTX 4080 16GB")
    print("FP8 = 8-bit floating point, ~50% memory reduction vs FP16")
    print("=" * 80)
    ...
    if available < 10000:
        ...
        print("This may not be enough for GPT-OSS 20B even with FP8.")
    ...
    print("\n🚀 Loading GPT-OSS 20B with FP8 quantization...")
    print("Settings:")
    print("  - Model: openai/gpt-oss-20b")
    print("  - Quantization: fp8 (8-bit floating point)")
    ...
    try:
        ...
        output_file = "gpt_oss_fp8_single_result.jsonl"
        ...
        print("\n" + "=" * 80)
        print("✅ SUCCESS - GPT-OSS 20B with FP8 works!")
        print("=" * 80)
        ...
        if "out of memory" in error_msg.lower() or "oom" in error_msg.lower():
            ...
            print("\nThe model is too large even with FP8 quantization.")
            print("\nOptions:")
        ...
        elif "quantization" in error_msg.lower() or "fp8" in error_msg.lower():
            print("⚠️  Quantization Error")
            print("\nvLLM may not support FP8 for this model.")
            print("\nOptions:")
            print("1. Try without quantization (may OOM)")
            ...
            print("\nMissing or incompatible Triton kernels.")
            print("\nOptions:")
            print("1. Try GGUF version: unsloth/gpt-oss-20b-GGUF")
            print("2. Update triton: pip install --upgrade triton")
