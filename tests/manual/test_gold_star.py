...
def test_export_icl():
    ...
    if response.status_code == 200:
        ...
        if len(lines) > 0:
            ...
            print(f"  ✅ Has 'messages' array")
            print(f"  ✅ Has 3 messages (system, user, assistant)")
            print(f"  ✅ All messages have 'role' and 'content'")
...
def test_export_finetuning():
    ...
    if response.status_code == 200:
        ...
        if len(lines) > 0:
            ...
            print(f"  ✅ Has 'messages' array")
            print(f"  ✅ Has 3 messages (system, user, assistant)")
            print(f"  ✅ Ready for OpenAI/Anthropic fine-tuning API")
...
def test_validation():
    ...
    if response.status_code == 400:
        ...
        print(f"❌ Validation failed - Should reject quality_score > 10")
        return False
