#!/usr/bin/env python3
"""
Test Qwen 3 4B with 100 samples to check quality
"""
...
def main():
    ...
    output_file = "qwen3_4b_100_results.jsonl"

    print("=" * 80)
    print("🧪 Testing Qwen 3 4B - 100 samples")
    ...
    for req in requests:
        ...
        # Format as chat template (Qwen uses standard chat format)
        prompt = ""
        for msg in messages:
            role = msg["role"]
            content = msg["content"]
    ...
    print("   Max Model Length: 4096")
    print("   Enforce Eager: True")
    print()
